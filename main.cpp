...
Eigen::Affine3f view = 
  ...
  Eigen::Translation3f(Eigen::Vector3f(0,0,-100));
...
Usage:
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    for(int i = 0;i<9;i++)
    {
      glUniform1i(glGetUniformLocation(prog_id, "mercury"), i==1);
      glUniform1i(glGetUniformLocation(prog_id, "venus"), i==2);
      glUniform1i(glGetUniformLocation(prog_id, "earth"), i==3);
      glUniform1i(glGetUniformLocation(prog_id, "mars"), i==4);
      glUniform1i(glGetUniformLocation(prog_id, "jupiter"), i==5);
      glUniform1i(glGetUniformLocation(prog_id, "saturn"), i==6);
      glUniform1i(glGetUniformLocation(prog_id, "uranus"), i==7);
      glUniform1i(glGetUniformLocation(prog_id, "neptune"), i==8);
